...
namespace Vistas;
class Plantilla{
    public string Crear(List<DatosParticipante> participantesActivos, List<DatosParticipante> participantesInactivos){
...
<body class='p-10'>
    ...
    <h2 class='text-2xl'>Reporte de participantes</h2> 
    </header>
    ...
    <table class='table-auto w-full border-collapse'>
          <thead>
            <tr class='max-w-4xl'>
                <h2 class='text-xl font-sans italic border border-black p-2 text-center'  style='background-color: #6EE7B7;'>PARTICIPANTES ACTIVOS</h2>
            </tr>
            <tr>
              <th class='bg-green-200 border-black border italic' style='background-color: #A7F3D0;'>ID</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #A7F3D0;'>Nombre</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #A7F3D0;'>Apellido</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #A7F3D0;'>Matrícula</th>
            </tr>
          </thead>
          <tbody>";

        foreach(DatosParticipante participante in participantesActivos){
            tablaHtml += @$"<tr>
              <td class='border border-black text-center'>{participante.IdDatosParticipante}</td>
              <td class='border border-black text-center'>{participante.Nombre}</td>
              <td class='border border-black text-center'>{participante.Apellido}</td>
              <td class='border border-black text-center'>{participante.Matricula}</td>
            </tr>";
        }
     ...
     <div class='container mx-auto py-8 max-w-4xl'>
            <table class='table-auto w-full border-collapse'>
              <thead>
                <tr>
                    <h2 class='text-xl font-sans italic border border-black p-2 text-center' style='background-color: #FCA5A5;'>PARTICIPANTES INACTIVOS</h2>
                </tr>
                <tr>
                  <th class='border-black border italic' style='background-color: #FECACA;'>ID</th>
                  <th class='border-black border italic' style='background-color: #FECACA;'>Nombre</th>
                  <th class='border-black border italic' style='background-color: #FECACA;'>Apellido</th>
                  <th class='border-black border italic' style='background-color: #FECACA;'>Matrícula</th>
                </tr>
              </thead>
              <tbody>";

        foreach(DatosParticipante participante in participantesInactivos){
            tablaHtml += @$"<tr>
                  <td class='border border-black text-center'>{participante.IdDatosParticipante}</td>
                  <td class='border border-black text-center'>{participante.Nombre}</td>
                  <td class='border border-black text-center'>{participante.Apellido}</td>
        ...
        tablaHtml += @$"</tbody>
            ...
            <table class='table-auto w-full border-collapse'>
              <tbody>
                <tr>
                  <td class='text-center'>Participantes activos</td>
                  <td class='text-center'>{participantesActivos.Count}</td>
                  
                </tr>
                <tr class='pb-5'>
                  <td class='text-center p-2'>Participantes inactivos</td>
                  <td class='text-center p-2'>{participantesInactivos.Count}</td>
                </tr>
                <tr>
                    <td class='text-center border-t border-black'>Total de participantes</td>
                    <td class='text-center border-t border-black'>{participantesActivos.Count + participantesInactivos.Count}</td>
                </tr>
              </tbody>
            </table>
        </div>
    ...
    return tablaHtml;
     ...
     public string CrearSeleccionados(List<Seleccionado> seleccionados){
...
<body class='p-10'>
    ...
    <table class='table-auto w-full border-collapse'>
          <thead>
            <tr class='max-w-4xl'>
                <h2 class='text-xl font-sans italic border border-black p-2 text-center'  style='background-color: #FBBF24;'>PARTICIPANTES ACTIVOS</h2>
            </tr>
            <tr>
              
              <th class='bg-green-200 border-black border italic' style='background-color: #FDE68A;'>Nombre</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #FDE68A;'>Apellido</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #FDE68A;'>Matrícula</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #FDE68A;'>Rol</th>
              <th class='bg-green-200 border-black border italic' style='background-color: #FDE68A;'>Fecha</th>
            </tr>
          </thead>
          <tbody>";
        ...
        foreach(Seleccionado seleccionado in seleccionados){
            tablaHtml += @$"<tr> 
              ...
              <td class='border border-black text-center'>{seleccionado.Rol}</td>
        ...
        tablaHtml += @$"
            ...
            <table class='table-auto w-full border-collapse'>
              <tbody>
                <tr>
                    <td class='text-center border-t border-black'>Total de participantes seleccionados</td>
                    <td class='text-center border-t border-black'>{seleccionados.Count}</td>
                </tr>
              </tbody>
            </table>
        </div>

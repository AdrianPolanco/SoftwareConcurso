...
<body class='p-10'>
    <header class='h-24 flex flex-col gap-5 justify-center items-center'>
       ...
       <h1 class='text-4xl'><span class='gradient-text'>Surprise Picker</span></h1>
    </div>
    ...
    <table class='table-auto w-full border-collapse'>
          <thead>
            <tr class='max-w-4xl'>
                <h2 class='text-xl font-sans italic border border-black p-2 bg-green-300 text-center'>PARTICIPANTES ACTIVOS</h2>
            </tr>
            <tr>
              <th class='bg-green-200 border-black border italic'>ID</th>
              <th class='bg-green-200 border-black border italic'>Nombre</th>
              <th class='bg-green-200 border-black border italic'>Apellido</th>
              <th class='bg-green-200 border-black border italic'>Matrícula</th>
            </tr>
          </thead>
          <tbody>";
     ...
     <div class='container mx-auto py-8 max-w-4xl'>
            <table class='table-auto w-full border-collapse'>
              <thead>
                <tr>
                    <h2 class='text-xl font-sans italic border border-black p-2 bg-red-300 text-center'>PARTICIPANTES INACTIVOS</h2>
                </tr>
                <tr>
                  <th class='bg-red-200 border-black border italic'>ID</th>
                  <th class='bg-red-200 border-black border italic'>Nombre</th>
                  <th class='bg-red-200 border-black border italic'>Apellido</th>
                  <th class='bg-red-200 border-black border italic'>Matrícula</th>
                </tr>
              </thead>
              <tbody>";
